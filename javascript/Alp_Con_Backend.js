...
beckend.prototype.alpInit =  function() {
	...
	this.adminProOeptions();
	this.adminProInactivety();
	this.adminProSelectPage();
	// this.adminProSelectPost();
...
beckend.prototype.adminCloseOptions = function () {
	$("#close_button_delay").change(function(){        
        if($(this).is(":checked"))  {
			$("#close_button_dealy_value").find("input[type='number']").val('0');
	...
	var delaytim = $('.delay_button_value').val(); 
		if(delaytim == ''){
 		  $("#close_button_dealy_value").hide();
	 	} else {
  			$("#close_button_dealy_value").show();
...
beckend.prototype.adminProDateRangeOptions = function () {
...
beckend.prototype.adminProSelectDateOeptions = function () {
...
beckend.prototype.adminProOeptions = function () {
...
beckend.prototype.adminProInactivety = function () {
	// inactivity time
...
beckend.prototype.adminProSelectPage = function () {
...
beckend.prototype.adminProSelectPost = function () {
	// SelectePosts                                                                     
...
beckend.prototype.adminProAutoClose = function () {
