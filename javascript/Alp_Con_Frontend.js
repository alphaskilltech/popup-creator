...
ALPCONPopup.prototype.popupOpenById = function (popupId) {
	 ...
	 alpOnScrolling = (ALP_CON_POPUP_DATA [popupId]['onScrolling']) ? ALP_CON_POPUP_DATA [popupId]['onScrolling'] : '';
	//  Inactivity = (ALP_CON_POPUP_DATA [popupId]['Inactivity']) ? ALP_CON_POPUP_DATA [popupId]['Inactivity'] : '';
	 AutoClosePopup = (ALP_CON_POPUP_DATA [popupId]['AutoClosePopup']) ? ALP_CON_POPUP_DATA [popupId]['AutoClosePopup'] : '';
...
ALPCONPopup.prototype.showPopup = function(id, isOnLoad) {
	...
	if (typeof ALP_CON_POPUP_DATA[id] == "undefined") {
		return;
	}
	...
	this.popupData = ALP_CON_POPUP_DATA[id];
...
// PopupEvents(onclick)
ALPCONPopup.prototype.alppopupOnclickEvents = function (){
	jQuery('#alpcolorbox').load("alpPopupClose", function () {
		jQuery('#alpcolorbox').css("display", "none");
		jQuery("#alpcboxOverlay").css("display", "none");
	});	
...
// (onhover)
ALPCONPopup.prototype.alppopupOnhoverEvents = function (){
	jQuery('#alpcolorbox').load("alpPopupClose", function () {
		jQuery('#alpcolorbox').css("display", "none");
		jQuery("#alpcboxOverlay").css("display", "none");
	});	
...
ALPCONPopup.prototype.colorboxEventsListener = function (){
	...
	var popupSelectEventsPopup = that.popupData['SelectEventsPopup'];	
	...
	jQuery('#alpcolorbox').on("alpColorboxOnOpen", function () {
		...
		if(popupSelectEventsPopup == 'onclick'){
			that.alppopupOnclickEvents();
		}else if(popupSelectEventsPopup == 'onhover'){
			that.alppopupOnhoverEvents();
		}
