								...
								<div id="normal-sortables" class="meta-box-sortables ui-sortable">
									<div class="postbox popupCreator_options_postbox alpSameWidthPostBox" style="display: block;">
										...
										<div class="optionsContent">										
											...
											<hr>
											<span class="liquid-width">Show Popup Based on Events :</span>
											<select class="btn  btn-large btn-primary" Name="SelectEventsPopup" id="dropDownId" value="<?php echo $alpSelectEventsPopup; ?>">											
